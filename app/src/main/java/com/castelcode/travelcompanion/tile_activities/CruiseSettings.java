...
import com.castelcode.travelcompanion.preferences.DatePreference;
import com.castelcode.travelcompanion.preferences.SelectNotificationPreferences;
import com.castelcode.travelcompanion.preferences.SetDrinkPricesPreferences;
...
import com.castelcode.travelcompanion.utils.InfoItemUtil;
...
public class CruiseSettings extends PreferenceActivity {
            ...
            Preference.OnPreferenceClickListener
    {
        ...
        public void onCreate(final Bundle savedInstanceState)
        {
            ...
            saveButton = findPreference(getString(R.string.trip_save_key));
            resetButton = findPreference(getString(R.string.trip_reset_key));
            loadButton = findPreference(getString(R.string.trip_load_key));
            deleteButton = findPreference(getString(R.string.trip_delete_key));
        ...
        private void saveButtonClicked() {
            ...
            builder.setMessage(R.string.trip_save_message)
        ...
        private void completeSave(SharedPreferences pref, Gson gson, String name,
            ...
            if (saveSuccessful) {
                ...
                editor.putString(getResources().getString(
                        R.string.trip_names), saveJsonText);
                editor.putString(getResources().getString(
        ...
        private void resetButtonClicked(){
            ...
            builder.setMessage(R.string.trip_reset_message)
        ...
        private void loadButtonClicked(){
            ...
            if (!loadedJsonText.equals("")) {
                ...
                Toast.makeText(getActivity(), getString(R.string.no_saved_trips),
                        Toast.LENGTH_SHORT).show();
                return;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(),
                    R.style.CustomAlertDialog);
            builder.setTitle(getResources().getString(R.string.trip_load_title))
        ...
        private void deleteButtonClicked(){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(),
                    R.style.CustomAlertDialog);
            builder.setTitle(getResources().getString(R.string.trip_delete_title))
                    .setItems(cruiseNames, (DialogInterface dialog, int which) ->
