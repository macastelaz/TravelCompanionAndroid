 ...
 */
package com.castelcode.travelcompanion.bluetooth;
...
public class BluetoothShareService {
     ...
     */
    public BluetoothShareService(Handler handler) {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Log.e(TAG, "Bluetooth is likely off causing a NPE", e);
                    break;
                }
