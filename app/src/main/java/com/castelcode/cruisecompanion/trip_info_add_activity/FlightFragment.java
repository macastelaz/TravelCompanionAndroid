...
public class FlightFragment extends Fragment implements View.OnClickListener{
    ...
    public void onViewCreated(View view, Bundle resources){
        ...
        if(viewToUse != null) {
            departureDateButton = (Button) viewToUse.findViewById(R.id.flight_departure_date_value);
            departureTimeButton = (Button) viewToUse.findViewById(R.id.flight_departure_time_value);
        ...
        if(info != null && viewToUse != null){
            ...
            EditText flightNumberText =
                    (EditText) viewToUse.findViewById(R.id.flight_number_value);
            flightNumberText.setText(info.getFlightNumber());
